    ...
    <div className="relative" ref={pickerRef}>
      ...
      {showPicker && (
        <>
          ...
          <div
            ref={pickerRef}
            className="fixed sm:absolute left-1/2 sm:left-auto sm:right-0 top-1/2 sm:top-full -translate-x-1/2 sm:translate-x-0 -translate-y-1/2 sm:translate-y-0 sm:mt-2 bg-white rounded-2xl shadow-2xl border border-slate-200 p-4 sm:p-6 z-50 w-[90vw] max-w-[400px] sm:max-w-none sm:w-[400px]"
          >
            {/* Month Selector */}
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {months.map((month, idx) => (
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium transition-all cursor-pointer ${currentMonth === idx
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[currentYear - 1, currentYear, currentYear + 1].map((year) => (
                    <button
                      ...
                      className={`px-3 py-2 rounded-lg text-sm font-medium transition-all cursor-pointer ${currentYear === year
