  ...
  return (
    <>
      ...
      <div className={`
        ...
        bg-white border-r border-teal-200/60 shadow-xl lg:shadow-sm 
        flex flex-col 
      ...
      `}>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500 truncate">{cls.teachername}</p>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        {/* Settings & Logout */}
        <div className={`bg-white transition-opacity duration-300 ${
          collapsed ? 'opacity-0' : 'opacity-100 p-6'
        }`}>
